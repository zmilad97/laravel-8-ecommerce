            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="form-horizontal" wire:submit.prevent="updateCategory">
                            <div class="form-group">
                                <label for="col-md-4 control-label">Category Name</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="col-md-4 control-label">Category Slug</label>
                                <div class="col-md-4">
