                                    ...
                                    @if(Auth::user()->uType ==='ADM')
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a title="Manage Sale " href="{{route('admin.sale')}}">Manage
                                                        Sale</a>
                                                </li>
                                    ...
                                    @else
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a title="All Orders " href="{{route('user.orders')}}">All
                                                        Orders</a>
                                                </li>
                                                <li class="menu-item"><a href="{{route('logout')}}"
                                                                         onclick="event.preventDefault(); document.getElementById('logout-form').submit()">Logout</a>
                ...
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                            ...
                            <li class="menu-item">
                                <a href="/card" class="link-term mercado-item-title">Cart</a>
                            </li>
                            <li class="menu-item">
...
<script src="https://cdn.tiny.cloud/1/4ymrlnyeubwg33pew8m6e2ffby5bre6opf03b82z5l8azvl9/tinymce/5/tinymce.min.js"
